    ...
    >
      <Section title="1. Who we are">
        <P>
          ...
          here. For anything on this page — a question, a correction, a copy of
          your data, or a deletion request — email{" "}
      ...
      <Section title="2. What we collect">
        ...
        <P>
          ...
          profile picture URL is stored but never displayed — every profile on
      ...
      <Section title="4. Why we use it">
        <UL>
          ...
          <li>
            ...
            abuse, and enforcing our{" "}
            <A href="/terms">terms of use</A>. This is our legitimate interest
            in running a service that is not overrun.
          </li>
        </UL>
      </Section>
      ...
      <Section title="5. YouTube and Google">
        ...
        <P>
          ...
          key — <strong>nothing that identifies you</strong> is sent. Google
          limits how long this cached information may be kept, so we refresh it
          at least every 30 days and drop it when a video is no longer
          available.
        </P>
        <P>
        ...
        <P>
          ...
          already stored, delete your account in{" "}
          <A href="/settings">settings</A>.
        </P>
      </Section>
      ...
      <Section title="7. What is visible to everyone">
        <P>
          ...
          videos, and the full comment thread on your profile — including the
          display name of everyone who has commented — are visible to anyone on
          the internet without an account, and can be indexed by search engines.
          Your profile page also produces link previews containing your name and
          bio when shared.
        </P>
        <P>
          Your email address is never shown anywhere on favTube.
        </P>
        <P>
          The private toggle in <A href="/settings">settings</A> hides your
          profile from everyone but you, removes it from the discover page, and
          asks search engines not to index it. It does not delete anything, and
          it has no effect on copies already made by search engines or other
          people.
        </P>
      </Section>
      ...
      <Section title="8. Cookies and local storage">
        <P>
          favTube sets one cookie, and it is the one that keeps you signed in.
          There are no analytics or advertising cookies, so there is no consent
          banner to click through.
        </P>
        <UL>
          <li>
            <strong>Session cookie</strong> — holds your sign-in token. It is
            HTTP-only, meaning scripts cannot read it, and it expires after 7
            days. Strictly necessary; without it you cannot stay signed in.
          </li>
          <li>
            <strong>Theme preference</strong> — your light or dark choice, kept
      ...
      <Section title="9. How long we keep it">
        <P>
          We keep your information for as long as your account exists. There is
          no scheduled deletion beyond that, other than sessions, which expire
          after 7 days, and cached YouTube video information, which is refreshed
          or removed at least every 30 days.
        </P>
        <P>
          <strong>When you delete your account</strong> — from the danger zone
          in <A href="/settings">settings</A> — it happens immediately. There is
          no grace period and no way to undo it. This permanently removes your
          user record, your sessions, your password hash and any Google tokens,
          your ranked videos, your follows in both directions, every comment you
          wrote <em>and</em> every comment other people left on your profile,
          and all your likes.
        </P>
        <P>Two things honestly do survive:</P>
        <UL>
          <li>
            Short-lived sign-in records created during Google sign-in are not
            linked to your account row, so they are not deleted with it. They
            contain no personal information beyond a temporary token, and they
            expire and are cleared on their own.
          </li>
          <li>
            If someone replied to one of your comments elsewhere, their reply is
            theirs and stays up — but it loses the label saying who it was
            replying to.
          </li>
        </UL>
        <P>
      ...
      <Section title="10. Your rights">
        ...
        <UL>
          <li>
            ...
            password are all editable in{" "}
            <A href="/settings">settings</A> and on your profile.
          </li>
          <li>
      ...
      <Section title="11. How we protect it">
        ...
        <Callout>
          <strong>An honest limit:</strong> favTube cannot send email. That
          means that if there were ever a breach affecting your data, we could
          not email you about it — we would post a notice on the site, and would
          notify the relevant authority where the law requires it. It is also
          why there is no password reset, as our{" "}
          <A href="/terms">terms of use</A> explains.
        </Callout>
      </Section>
